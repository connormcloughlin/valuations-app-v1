...
module.exports = {
  "expo": {
    ...
    "ios": {
      "supportsTablet": true,
      "bundleIdentifier": "com.qantam.valuations",
      "associatedDomains": ["applinks:com.qantam.valuations"]
    },
    "android": {
      "package": "com.qantam.valuations",
      "adaptiveIcon": {
    ...
    "plugins": [
      ...
      [
        "react-native-msal",
        {
          ...
          "additionalScopes": [`api://${process.env.AZURE_API_CLIENT_ID}/.default`],
