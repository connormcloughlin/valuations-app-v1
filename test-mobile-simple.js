...
async function testMobileAppIntegration() {
  ...
  console.log(`🎯 Testing Entity: riskAssessmentItem/999\n`);
  ...
  try {
    ...
    const uploadResult = await uploadMediaMobile({
      ...
      entityName: 'riskAssessmentItem', // Fixed: backend expects camelCase
      entityID: 999,
    ...
    const retrievalResult = await getMediaForEntityMobile('riskAssessmentItem', 999);
